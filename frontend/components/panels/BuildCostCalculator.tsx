      ...
      <div className="space-y-6">
            ...
            {DEV_TYPES.map(dt => (
              <button
                ...
                className={`flex items-center justify-between px-4 py-3 border-2 text-left transition-colors ${
                  devType === dt.id
                    ? 'border-swiss-black bg-swiss-black text-white'
                    : 'border-swiss-black/30 hover:border-swiss-black'
                }`}
              >
        ...
        <div>
          ...
          <input
            ...
            className="w-full accent-swiss-black h-2 cursor-pointer"
          />
        ...
        {/* Results */}
        <div className="border-t-4 border-swiss-black pt-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="border-2 border-swiss-black/30 p-4">
              <p className="text-xs uppercase tracking-widest font-bold opacity-60 mb-1">Build Cost</p>
              <p className="text-2xl font-black text-red-600">£{buildCost.toLocaleString('en-GB')}</p>
            ...
            <div className="border-2 border-swiss-black/30 p-4">
              ...
              <p className="text-2xl font-black text-green-600">£{Math.round(valueAdded).toLocaleString('en-GB')}</p>
              <p className="text-xs opacity-40 mt-1">@ £{avgPricePerM2.toLocaleString('en-GB')}/m² × 85%</p>
            </div>
          </div>

          <div className="border-4 border-swiss-black p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-3xl font-black ${profitPositive ? 'text-green-600' : 'text-red-600'}`}>
